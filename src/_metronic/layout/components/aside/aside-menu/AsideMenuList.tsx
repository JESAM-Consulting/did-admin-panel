      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        <>
          {userInfo?.role?.roleName === "admin" && (<>
              ...
              <NavLink className="menu-link" to="/contact-us">
                <span className="svg-icon menu-icon">
                  <i
                    ...
                    style={{ fontSize: "13px", color: "#383839", rotate: "-270deg" }}
                  ></i>
                </span>
            ...
            <li
              className={`menu-item ${getMenuItemActive("/subscribe", false)}`}
              aria-haspopup="true"
            >
...
{userInfo?.role?.roleName == "admin" || userInfo?.role?.roleName == "user" ? <>
            <li
              className={`menu-item ${getMenuItemActive("/manage-property", false)}`}
              aria-haspopup="true"
            >
              <NavLink className="menu-link" to="/manage-property">
                <span className="svg-icon menu-icon">
            ...
            <li
              className={`menu-item ${getMenuItemActive("/apraisal", false)}`}
              aria-haspopup="true"
            >
            ...
            <li
              className={`menu-item ${getMenuItemActive("/search-query", false)}`}
              aria-haspopup="true"
            >
            ...
            <li
              className={`menu-item ${getMenuItemActive("/license-partner", false)}`}
              aria-haspopup="true"
            >
